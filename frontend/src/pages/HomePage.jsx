...
import { CheckCheckIcon, MapPinIcon, UserIcon, UserPlus2Icon } from 'lucide-react';
...
const HomePage = () => {
  ...
  const {data:recommenderUsers=[],isLoading:loadingUsers} = useQuery({
    queryKey:["users"],
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="container mx-auto space-y-10">
        <div className="flex flex-control sm:flex-row items-start sm:items-center justify-between gap-4">
