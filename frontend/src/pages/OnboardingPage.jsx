            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div clasName="form-control">
                ...
                <input type="text" name="fullName" value={formState.fullName} 
                    ...
                    className="input input-board w-full"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="form-control">
                    ...
                    <select
                      ...
                      className="select select-board w-full">
                      <option value="">
                        Select your native language
                      </option>
                      {LANGUAGES.map((lang)=>(<option key={`native-${lang}`} value={lang.toLowerCase()}>
                        {lang}
                      </option>))}
                    </select>
                  </div>
                ...
                <div className="form-control">
                  ...
                  <div className="relative">
                    ...
                    <input type="text" name="location" value = {formState.location}
                        ...
                        className="input input-board w-full pl-10"
